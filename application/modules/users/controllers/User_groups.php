...
class User_groups extends MY_Controller
{
	...
	public function create_group()
	{
		...
		$this->form_validation->set_rules('privilege[]', "You Must Have to Select at least one Previlige", 'trim|required');

		$group_name = $this->input->post('group_name');
		$description = $this->input->post('description');
		$pre = $this->input->post('privilege');

		if ($this->form_validation->run() == true && !empty($pre) ) {
	...
	public function edit_group($id)
	{
		...
		// validate form input
		$this->form_validation->set_rules('group_name', $this->lang->line('create_group_validation_name_label'), 'trim|required');
		$this->form_validation->set_rules('privlg[]', "You Must Have to Select at least one Previlige", 'trim|required');
