                                 ...
                                 <td>
                                    <div class="btn-group btn-space">
                                       ...
                                       <div class="dropdown-menu" role="menu">
                                          ...
                                          <a class="dropdown-item" onclick="deleteFunction('<?php echo base_url('users/delete_user').'/'. $user->id; ?>')" href="javascript:void(0)"> <span class="icon mdi mdi-delete"></span> Delete User</a>
