  ...
  <div class="row">
    <div class="col-md-4 col-md-offset-4">
      <div class="panel panel-default">
        <div class="panel-heading" style="text-align: center;  padding: 19px;">
        <img src="<?= base_url('public/assets/img/MedicareUSA-logo.png')?>" class="float-left ml-4 mb-2 w-auto">
          <h2><?php echo lang('forgot_password_heading');?></h2>
        </div>
        <div class="panel-body">
          <?php echo form_open("backoffice/register/forgot_pass",'class="form-horizontal"');?>
        ...
        <div class="panel-footer">
          <div class="clearfix">
            <a href="<?= base_url('backoffice/Auth/login') ?>" class="btn btn-default pull-left">Go Back</a>
