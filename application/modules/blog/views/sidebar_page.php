		...
		<div class="container">
			...
			<div class="form-block">				
				<form id="get_sidebar_frm_mobile" method="get" action="<?php postUrl(); ?>/planlist" class="find-plan-form">
					...
					<input type="text"  onKeyup="returncountySide1()" value="<?php echo returnZipCode();?>" onkeypress="return isNumber(event)" maxlength="5" name="zip" id="zipcode_side1" class="form-control" placeholder="Enter ZIP code">
			...
			<div class="col-lg-4 col-xl-3">
				<div class="right-block">
					<div class="find-plan-block d-none d-lg-block dynamic_phoneno">
						...
						<input type="hidden" id="state_side" name="state" value="">
							</div>
							<input type="text"  onKeyup="returncountySide()" value="<?php echo returnZipCode();?>" onkeypress="return isNumber(event)" maxlength="5" name="zip" id="zipcode_side" class="form-control rounded-0 border-0 shadow-none col-lg-12 mx-auto" placeholder="Enter ZIP code">
