        ...
        else
        {
            if ($_POST['g-recaptcha-response'] == TRUE) 
            {
                ...
                else
                {
                    ...
                    $this->session->set_flashdata('error',$msg);
                    redirect('backoffice/Register','refresh');
                } 
            }
            else
            {
        ...
        if ($this->input->post()) 
        {
            ...
            if ($this->form_validation->run() === TRUE)
            {
                ...
                else
                {
                    ...
                    $this->session->set_flashdata('error',$msg);
                    redirect('backoffice/Register/verifycode','refresh');
                }
            }   
            else
            {
    ...
    public function forgot_pass()
    {
        if ($this->input->post()) 
        {
            ...
            if (!empty($get_user)) 
            {
                ...
                $msg        = 'Hi Dear, <br> Please Click the Below link to Update Your Password: <br> <h3>'.base_url('backoffice/auth/reset_password/'.$random.'').'</h3> <br><br> Thanks';;
                ...
                if ($result) 
                {
                    ...
                    $this->session->set_flashdata('success',$msg);
                    redirect('backoffice/register/forgot_pass','refresh');
                }
                else
                {
        ...
        {
            $this->load->view('backoffice/auth/forgot_password');
        }
    }
