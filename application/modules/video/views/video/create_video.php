      ...
      <div class="row">
         <div class="col-sm-12">
            ...
            <div class="card card-table card-border-color card-border-color-primary">
               <div class="card-header"> <span class="icon mdi mdi-web"></span> Create Vodeo
               </div>
               <div class="card-body">
                  <div class="row">
                     <div class="col-sm-6 offset-sm-2">
                        <?= form_open('video/video/add_video', array('id' => 'video_form_validation', 'class' => 'form-horizontal')); ?>
                        ...
                        <div class="form-group">
							<label class="control-label">Thumble Image</label>
							...
							<div id="thumble_image_upload"><img style="height:200px;width:358px;" src="https://avatars0.githubusercontent.com/u/3456749"  id="thumble_image_post_img"></div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.1/jquery.js" integrity="sha256-WpOohJOqMqqyKL9FccASB9O0KwACQJpFTUBLTYOVvVU=" crossorigin="anonymous"></script>
	...
	<div class="modal fade" id="modal_thum" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true" aria-hidden="true" data-backdrop="static" data-keyboard="false">
