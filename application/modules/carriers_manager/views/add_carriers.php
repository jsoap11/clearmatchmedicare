...
<div class="be-content">
   <div class="page-head">
      <h2 class="page-head-title">Add Carrier</h2>
      ...
      <div class="row">
         <div class="col-sm-12">
            ...
            <div class="card card-table  card-border-color card-border-color-primary">
               <div class="card-header"> <span class="icon fa fa-file-text"></span> Add Carrier

               </div>
               <div class="card-body">
                  <div class="row mx-2">
                     <div class="col-sm-12">
                        <form action="<?= base_url('carriers_manager/add') ?>" enctype="multipart/form-data"  method="post" class="form-horizontal row-border">
                           ...
                           <div class="form-group">
							...
							<div class="form-group">
                              ...
                              <div class="col-sm-12 col-md-12">
                                    ...
                                    <textarea name="terms_and_conditions" id="terms_and_conditions"  class="form-control" rows="3" >
