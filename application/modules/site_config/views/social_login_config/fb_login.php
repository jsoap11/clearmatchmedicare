<div class="be-content">
	<div class="page-head">
		<h2 class="page-head-title">FB Social Login</h2>
		<nav aria-label="breadcrumb" role="navigation">
			<ol class="breadcrumb page-head-nav">
				<li class="breadcrumb-item"><a href="#">Home</a></li>
				<li class="breadcrumb-item"><a href="#">Social Login</a></li>
				<li class="breadcrumb-item active">Facebook Setup</li>
			</ol>
		</nav>
	</div>
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="card card-table card-border-color card-border-color-primary">
					<div class="card-header"> <span class="icon mdi mdi-facebook-box"></span> Facebook Setup
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-md-9">
