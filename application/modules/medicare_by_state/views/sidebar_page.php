                    ...
                    <div class="sticky-top">
                      ...
                      <form id="get_sidebar_frm" method="get" action="<?php postUrl(); ?>/planlist" class="find-plan-form">
						<div style="display:none">
						  ...
						  <input type="text" onKeyup="returncountySide()" onkeypress="return isNumber(event)" maxlength="5" name="zip" id="zipcode_side" class="form-control rounded-0 border-0 shadow-none col-lg-12 mx-auto" placeholder="Enter ZIP code" value="<?php echo returnZipCode();?>">
