			...
			<header class="fixed-header">
				<div class="container container-full">
					<div class="top-header">
						<div class="row">
							...
							<div class="col-4 col-md-6 col-lg-5 header-call-now-block d-none d-lg-block">
							...
							<div class="col-4 col-lg-3 text-right align-self-center justify-content-end">
				...
				<nav class="bg-blue p-md-0 nav1">
					<div class="container cnttr nav-container container-full">
						<a href="javascript:void(0);" class="close-toggle d-lg-none"><i class="fa fa-times" aria-hidden="true"></i></a>
						<div class="menu-block">
							<div class="d-flex justify-content-md-start justify-content-center flex-column">
								<div class="header-details d-lg-none">
				...
				?>
				<div class="search-form-block d-lg-none active <?php echo $class; ?>">
					<div class="container">
