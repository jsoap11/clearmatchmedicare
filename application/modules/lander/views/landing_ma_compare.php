		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-12">
					...
					<form method="get" action="<?php postUrl(); ?>" id="landingmacompareFrm">
						<div class="compare-form">	
							<div style="display:none">
								<input type="hidden" id="gender" name="gender" value="F">	
								<input type="hidden" name="lander_name" value="landing_ma_compare">
								<input type="hidden" name="pgName" value="landing_ma_compare">
							...
							<div class="form-group rounded d-flex zip-code-box lander-type-d justify-content-center">
								<input value="<?php echo returnZipCode();?>" type="text" onblur="returncounty()" onkeypress="return isNumber(event)" maxlength="5" name="zipcode" id="zipcode" placeholder="Enter ZIP Code" class="form-control">
								<input type="button" onClick="return frmLandingmacompare()" value="SEE PLANS" class="btn btn-submit">
							</div>
						</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body text-center">
					...
					<div class="button-block">
						<div class="row">
							<div class="col-md-6">
								<a href="javascript:void(0)" onclick="submitFrm('drugBasket','landingmacompareFrm')" class="btn btn-drugs">ENTER DRUGS</a>
							</div>
							<div class="col-md-6">
								<a href="javascript:void(0)" onclick="submitFrm('planlist','landingmacompareFrm')" class="btn btn-plans">SEE PLANS</a>
