...
<div id="newtimer"></div>
<div class="jumbotron landingpage-jumbotron callus-jumbotron findaplan2-jumbotron">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-md-12 col-12 jumbotron-column">
				<div class="jumbotron-subblock">
					<h1>Find a Medicare Plan <br />That’s Right for You!</h1>
					<h6>Get started by entering your zip code.</h6>
					<form id="findaPlan2Frm" method="get" action="<?php postUrl(); ?>" class="compare-form">	
						<div style="display:none">
								<input type="hidden" id="gender" name="gender" value="F">	
							<input type="hidden" name="pgName" value="findaPlan2">
						...
						<button type="button" onclick="frmFindaPlan2('<?php csd(); ?>')" class="btn btn-submit">See Plans</button>
					</form>
...
<section class="partner-logo-block lander-partner-logo-block callus-partner-logo-block findaplan2-partner-logo-block">
	<div class="container">
...
<section class="getting-started-block callus-getting-started-block findaplan2-getting-started-block">
	<div class="container">
		...
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				...
				<div class="button-block">
					<div class="row">
						<div class="col-md-6">
							<a href="javascript:void(0)" onclick="submitFrmplan('drugBasket','findaPlan2Frm')" class="btn btn-drugs">ENTER DRUGS</a>
						</div>
						<div class="col-md-6">
							<a  href="javascript:void(0)" onclick="submitFrmplan('planlist','findaPlan2Frm')"  class="btn btn-plans">SEE PLANS</a>
