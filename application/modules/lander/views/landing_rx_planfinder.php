...
<main class="lander-block">
	<div id="newtimer"></div>
	<div class="jumbotron custom-jumbotron new-jumbotron search-jumbotron">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-12">
					<h1>All-in-One Medicare Plan Finder</h1>
					<h2>Discover affordable Medicare Part D plans that may help you save!</h2>
					<form method="get" action="<?php postUrl(); ?>" id="landingrxplanfinderFrm">
						<div class="compare-form">
							<div style="display:none">
								<input type="hidden" id="gender" name="gender" value="F">	
								<input type="hidden" name="lander_name" value="landing_rx_planfinder">
								<input type="hidden" name="pgName" value="landing_rx_planfinder">
								...
								<input type="hidden" id="landing_tab" name="landing_tab" value="pdp">
							</div>
							<div class="form-group rounded d-flex zip-code-box lander-type-d justify-content-center">
								...
								<input type="button" onClick="frmLandingrxplanfinder()" value="SEE PLANS" class="btn btn-submit">
							</div>
						</div>
	...
	<div class="partner-bg-light">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-3">
					<img src="<?php echo bs() ?>front_assets/image/carrier/cigna.png" class="img-fluid carrier_logo"  alt="clearmatchmedicare">
				</div>

				<div class="col-3">
					<img src="<?php echo bs() ?>front_assets/image/carrier/humana.png" class="img-fluid carrier_logo"  alt="clearmatchmedicare">
				</div>

				<div class="col-3">
					<img src="<?php echo bs() ?>front_assets/image/carrier/silverscript.png" class="img-fluid carrier_logo"  alt="clearmatchmedicare">
				</div>

				<div class="col-3">
					<img src="<?php echo bs() ?>front_assets/image/carrier/wellcare.png" class="img-fluid carrier_logo"  alt="clearmatchmedicare">
				</div>
			</div>
		</div>
	</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				...
				<div class="button-block">
		  			<div class="row">
			  			<div class="col-md-6">
							<a href="javascript:void(0)" onclick="submitFrm('drugBasket','landingrxplanfinderFrm')" class="btn btn-drugs">ENTER DRUGS</a>
						</div>
						<div class="col-md-6">
							<a href="javascript:void(0)" onclick="submitFrm('planlist','landingrxplanfinderFrm')" class="btn btn-plans">SEE PLANS</a>
