...
<div id="newtimer"></div>
<div class="jumbotron landingpage-jumbotron callus-jumbotron">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-md-12 col-12">
				...
				<h6>Call now to speak with a caring, licensed insurance <br />agent for your <strong>Free Medicare Review.</strong></h6>
				<div class="content-block d-none d-md-block dynamic_phoneno">
					<h1>Call Us Today! <br /><?php echo (isset($_COOKIE['site_phone']))?$_COOKIE['site_phone']:displayPhoneNo();?>/TTY:711</h1>
					<h6><?php displayTime(); ?></h6>
				</div>
				<div class="content-block d-md-none dynamic_phoneno">
					<div class="button-block"><a href="tel:<?php echo (isset($_COOKIE['site_phone']))?$_COOKIE['site_phone']:displayPhoneNo();?>" class="btn">Call Now!</a></div>
					<h6><?php displayTime(); ?></h6>
				</div>
			</div>
		</div>
...
<section class="partner-logo-block lander-partner-logo-block callus-partner-logo-block">
	<div class="container">
		<div class="partner-logo-subblock">
			<div class="logo-img"><img alt="aetna" src="<?= bs() ?>front_assets/image/landing/aetna.png" class="img-fluid"></div>
			<div class="logo-img"><img alt="cigna" src="<?= bs() ?>front_assets/image/landing/cigna.png" class="img-fluid"></div>
			<div class="logo-img wellcare-img"><img alt="wellcare" src="<?= bs() ?>front_assets/image/landing/wellcare.png" class="img-fluid wellcare-logo"></div>
			<div class="logo-img moo-img"><img alt="moo" src="<?= bs() ?>front_assets/image/landing/moo.png" class="img-fluid"></div>
			<div class="logo-img"><img alt="humana" src="<?= bs() ?>front_assets/image/landing/humana.png" class="img-fluid"></div>
		</div>
...
<section class="getting-started-block callus-getting-started-block">
	<div class="container">
		<div class="getting-started-subblock">
			<div class="row">
				<div class="col-md-6">
					<div class="left-block">
						<h1>Find a Medicare Plan <br />That’s Right for You!</h1>
						<p>Get started by entering your zip code.</p>
					</div>
				</div>
				<div class="col-md-6">
					<div class="right-block d-none">
					...
					<div class="right-block">
						<form id="callusFrm" method="get" action="<?php postUrl(); ?>" class="callusform">	
							...
							<button type="button" onclick="frmCallus('<?php csd(); ?>')" class="btn btn-submit d-none d-md-block">Find Plans</button>
							<button type="button" onclick="frmCallus('<?php csd(); ?>')" class="btn btn-submit d-md-none">See Plans</button>
						</form>
		...
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				...
				<div class="button-block">
					<div class="row">
						<div class="col-md-6">
							<a href="javascript:void(0)" onclick="submitFrmplan('drugBasket','callusFrm')" class="btn btn-drugs">ENTER DRUGS</a>
						</div>
						<div class="col-md-6">
							<a  href="javascript:void(0)" onclick="submitFrmplan('planlist','callusFrm')"  class="btn btn-plans">SEE PLANS</a>
