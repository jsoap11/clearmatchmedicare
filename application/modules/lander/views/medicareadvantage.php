...
<main class="lander-block">
	<div id="newtimer"></div>
	<div class="new-jumbotron search-jumbotron landing-jumbotron medicareadvantage-jumbotron">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-12">
					<h1>2022 Medicare Advantage Plans</h1>
					<h2>Discover affordable Medicare Advantage plans that may help you save!</h2>
					<form method="get" action="<?php postUrl(); ?>" id="medicareadvantageFrm">
						<div class="compare-form">
							...
							<div class="form-group rounded d-flex zip-code-box lander-type-d justify-content-center">
								...
								<input type="button" onClick="return frmMedicareadvantage()" value="SEE PLANS" class="btn btn-submit">
							</div>
						</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				...
				<div class="button-block">
					<div class="row">
			  			<div class="col-md-6">
							<a href="javascript:void(0)" onclick="submitFrm('drugBasket','medicareadvantageFrm')" class="btn btn-drugs">ENTER DRUGS</a>
						</div>
						<div class="col-md-6">
							<a href="javascript:void(0)" onclick="submitFrm('planlist','medicareadvantageFrm')" class="btn btn-plans">SEE PLANS</a>
