        ...
        <div class="row">
            <div class="img-holder">
                ...
                <div class="info-holder">
                    <img src="<?= bs() ?>public/assets/img/MedicareUSA-logo.png" class="float-left ml-4 mb-2 w-auto">
                ...
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <div class="page-links">
                            <a href="<?= base_url('users/auth/login') ?>">Login</a><a href="<?= base_url('users/Register') ?>" class="active">Register</a>
                        </div>
                        <form action="<?php bs() ?>users/Register/sign_up" method="post" id="myform">
