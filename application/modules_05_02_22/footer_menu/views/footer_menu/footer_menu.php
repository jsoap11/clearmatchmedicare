<div class="be-content">
   <div class="page-head">
      <h2 class="page-head-title">Footer Menu</h2>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form action="<?= base_url('footer_menu') ?>" id="mainMenuFrm" method="post" role="form">
...
<div class="modal fade colored-header colored-header-primary" id="myModal" tabindex="-1" role="dialog">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form class="" action="<?= base_url('footer_menu/sub_menu') ?>" id="subMenuFrm" method="post" role="form">
               <div class="form-group">
                  <label>
...
<script>
   function editMenu(level,id){
      $.ajax({
            url: "<?php bs('footer_menu/get_perm') ?>/" + id,
            type: 'POST',
            data: {
               id: id,
               level: level
            ...
            success: function(success) {
               ...
               if (obj.level == 0) {
                  ...
                  $('#slug').val(obj.slug);
                  $('#id').val(obj.menu_id);
                  $('#mainMenuFrm').attr("action","<?= base_url('footer_menu/update_menu') ?>");
               } else if(obj.level == 1) {
                  $('#myModal').modal('show');
                  ...
                  $('#slug2').val(obj.slug);
                  $('#id2').val(obj.menu_id);
                  $('#subMenuFrm').attr("action","<?= base_url('footer_menu/update_menu') ?>");
               }
            }
         })
   }
