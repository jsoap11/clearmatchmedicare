         ...
         <div class="col-sm-12">
            ...
            <div class="card card-table  card-border-color card-border-color-primary">
               ...
               <div class="card-body">
                  <div class="row ml-5">
                     <div class="col-sm-12">
                        <form action="<?= base_url('static_content/static_cont_ent') ?>" enctype="multipart/form-data" method="post" class="form-horizontal blog_settings row-border">
                           <div class="form-group">
                              <div class="row">
                                 <div class="col-sm-10">
                                    <label class=" control-label">Footer content</label>
                                    <textarea name="footer_content" id="footer_content" class="form-control" rows="5" required><?php echo $settings[0]->footer_content ?></textarea>
                                 </div>
                              </div>
                           </div>
                           <div class="form-group">
