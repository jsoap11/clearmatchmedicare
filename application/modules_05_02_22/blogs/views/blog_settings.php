...
<div class="be-content">
   <div class="page-head">
      <h2 class="page-head-title">Blogs Settings</h2>
      <nav aria-label="breadcrumb" role="navigation">
         <ol class="breadcrumb page-head-nav">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item"><a href="#">Blogs</a></li>
            <li class="breadcrumb-item active">Blogs Settings</li>
         </ol>
      </nav>
   </div>
      ...
      <div class="row">
         <div class="col-sm-12">
            ...
            <div class="card card-table  card-border-color card-border-color-primary">
               <div class="card-header"> <span class="icon mdi mdi-settings mb-5"></span> Blogs Settings

               </div>
               <div class="card-body">
                  <div class="row ml-5">
                     <div class="col-sm-12">
                        <form action="<?= base_url('blogs/BlogSettings/blog_settings') ?>" enctype="multipart/form-data" method="post" class="form-horizontal blog_settings row-border">
							<div class="form-group">
                              <div class="row">
                                 <div class="col-sm-5">
                                    <label class=" control-label">Meta Title</label>
                                    <input type="text" name="meta_title" value="<?php echo $settings->meta_title ?>" class="form-control" required>
                                 </div>
								  <div class="col-sm-5">
                                    <label class=" control-label">Download Search Log</label>
									  <a href="<?= base_url('/blogs/posts/search_posts') ?>">Click here</a>
                                 </div>
                              </div>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              <div class="row">
                                 ...
                                 <div class="col-sm-5">
                                    <label class=" control-label">Enable/Disable Comments </label>
                           ...
                           <div class="form-group">
                              <div class="row">
                                 <div class="col-sm-5">
                                    <label class=" control-label">Enable/Disable Category Posts </label>
                                 ...
                                 <div class="col-sm-5">
                                    ...
                                    <input type="link" name="twitter" value="<?php echo $settings->twitter ?>" class="form-control" required>
                                    </select>
                                 </div>
                              </div>
                           </div>
						 ...
						 <div class="form-group">
                              <div class="row">
                                 <div class="col-sm-5">
                                    <label class=" control-label">Category Meta Description</label>
                                    <textarea name="cat_meta_desc" class="form-control" rows="5" required><?php echo $settings->cat_meta_desc ?></textarea>
                                 </div>  
                                 <div class="col-sm-5">
                                    <label class=" control-label">Category Meta Title</label>
                                    <input type="text" name="cat_meta_title" value="<?php echo $settings->cat_meta_title ?>" class="form-control" required>
                                 </div>
                              </div>
                           </div>
						 <div class="form-group">
                              <div class="row">
                                 <div class="col-sm-5">
                                    <label class=" control-label">Tag Meta Description</label>
                                    <textarea name="tag_meta_desc" class="form-control" rows="5" required><?php echo $settings->tag_meta_desc ?></textarea>
                                 </div>
                                 <div class="col-sm-5">
                                    <label class=" control-label">Tag Meta Title</label>
                                    <input type="text" name="tag_meta_title" value="<?php echo $settings->tag_meta_title ?>" class="form-control" required>
                                 </div>
                              </div>
                           </div>
                           <div class="form-group">
