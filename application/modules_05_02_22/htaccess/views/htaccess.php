   ...
   <div class="page-head">
      ...
      <nav aria-label="breadcrumb" role="navigation">
         <ol class="breadcrumb page-head-nav">
            ...
            <li class="breadcrumb-item active">Update .htaccess</li>
         </ol>
      </nav>
   </div>
      ...
      <div class="row">
         <div class="col-sm-12">
            ...
            <div class="card card-table  card-border-color card-border-color-primary">
               <div class="card-header"> <span class="icon mdi mdi-settings mb-5"></span> Htaccess Content

               </div>
               <div class="card-body">
                  <div class="row ml-5">
                     <div class="col-sm-12">
                        <form action="<?= base_url('htaccess/htaccess/write') ?>" enctype="multipart/form-data" method="post" class="form-horizontal blog_settings row-border">
                           <div class="form-group">
                              <div class="row">
                                 <div class="col-sm-10">
                                    <label class=" control-label">Robots content</label>
                                    <textarea name="htaccess" id="htaccess" class="form-control" rows="5" required><?php echo $settings; ?></textarea>
                                 </div>
                              </div>
                           </div>
                           <div class="form-group">
