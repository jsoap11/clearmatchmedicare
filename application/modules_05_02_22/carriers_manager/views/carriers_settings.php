...
<div class="be-content">
   <div class="page-head">
      <h2 class="page-head-title">Carriers Settings</h2>
      <nav aria-label="breadcrumb" role="navigation">
         <ol class="breadcrumb page-head-nav">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item"><a href="#">Carriers Manager</a></li>
            <li class="breadcrumb-item active">Carriers Settings</li>
         </ol>
      </nav>
   </div>
      ...
      <div class="row">
         <div class="col-sm-12">
            ...
            <div class="card card-table  card-border-color card-border-color-primary">
               <div class="card-header"> <span class="icon mdi mdi-settings mb-5"></span> Carriers Settings

               </div>
               <div class="card-body">
                  <div class="row ml-5">
                     <div class="col-sm-12">
                        <form action="<?= base_url('content_manager/content_settings/content_settings') ?>" enctype="multipart/form-data" method="post" class="form-horizontal blog_settings row-border">
                           <div class="form-group">
							...
							<div class="form-group">
                              <div class="row">
                                 <div class="col-sm-5">
                                    <label class=" control-label">Meta Description(Find A Paln)</label>
                                    <textarea name="meta_desc" class="form-control" rows="5" required><?php echo $settings->meta_desc ?></textarea>
                                 </div>
                                 <div class="col-sm-5">
                                    <label class=" control-label">Meta Title(Find A Paln)</label>
