				...
				<div class="col-12 col-md-12">
					<div class="heading-group-box">
						<div class="landing-heading-form-background header-box-height zip-box-padding">
							...
							<form method="post" action="<?php echo bs() ?>lander/demographics" id="landingFrm" class="col-12 col-md-8 col-lg-8 px-0">
								<div style="display:none">
								<input type="hidden" id="gender" name="gender" value="F">	
									<input type="hidden" name="lander_name" value="landing">
									<input type="hidden" name="pgName" value="landing">
								...
								<div class="form-group rounded d-flex zip-code-box lander-type-d">
									<input type="text" value="<?php echo returnZipCode();?>" onblur="returncounty()" onkeypress="return isNumber(event)" maxlength="5" name="zip" id="zip" placeholder="Enter ZIP Code" class="form-control align-self-center zip-fixed border-0 shadow-none open-sans m-0 border border-black-20 border-right-0">
									<input type="button" onClick="return frmLanding()" value="SEE PLANS" class="btn-lg btn bg-red btn-red-radius rounded-0 px-3 px-md-4 text-white open-sans">
								</div>
