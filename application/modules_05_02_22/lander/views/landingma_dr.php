<body>
	...
	<main>	
		...
		<div id="newtimer"></div>
		<div class="jumbotron custom-jumbotron new-jumbotron search-jumbotron dr-lander-jumbotron">
			<div class="container">
				<div class="row">
					<div class="col-lg-7 col-md-7 col-12">
						<h1>Find a Medicare Plan <br />with your Doctors</h1>
						<h2>Compare Medicare Advantage plans that include <br />your doctors to help you save on medical cost.</h2>
						<form method="GET" action="<?php postUrl(); ?>/planlist" id="landingmaDrFrm" class="compare-form">	
							<div style="display:none">
								<input type="hidden" id="gender" name="gender" value="F">	
								<input type="hidden" name="lander_name" value="landing_ma_dr">
								<input type="hidden" name="pgName" value="landing_ma_dr">
								...
								<input type="hidden" name="transferPage" id="transferPage" value="doctorLookup"> <!--doctorLookup/planlist/guide-->
							...
							<button type="button" onclick="return frmLandingmaDr()" class="btn btn-submit">GET STARTED</button>
						</form>
