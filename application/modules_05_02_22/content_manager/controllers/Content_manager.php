...
class Content_manager extends MY_Controller
{
	...
	{
		$data['posts'] = $this->common_model->getAllData('blog_post', '*', '', array('deleted_at' => 'Null','type' => 2));

		$data['page'] = "content_manager/content_manager";
	...
	public function add()
	{
		...
		if (isset($_POST) && !empty($_POST) && $this->form_validation->run() == TRUE) {
			...
			$data['page'] = "content_manager/add_content";
			$this->template->template_view($data);
		}
	}
	...
	public function edit($id = '')
	{
			...
			$data['page'] = "content_manager/edit_content";
			$this->template->template_view($data);
		}
	}
