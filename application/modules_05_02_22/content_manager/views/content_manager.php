...
<div class="be-content">
   <div class="page-head">
      <h2 class="page-head-title">Content List</h2>
      ...
      <div class="row">
         <div class="col-sm-12">
            ...
            <div class="card card-table  card-border-color card-border-color-primary">
               <div class="card-header"> <span class="icon fa fa-file-text"></span> Content List
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <?php if ($post->status == 1) : ?>
                                             ...
                                             <a href="<?php bs() ?>content_manager/unpublish/<?php echo $post->id ?>" data-toggle="tooltip" data-placement="top" title="Click to Change Status">
                                                <button type="button" class="btn btn-success btn-xs">Publish</button>
                                             </a>

                                          <?php else : ?>

                                             <a href="<?php bs() ?>content_manager/publish/<?php echo $post->id ?>" data-toggle="tooltip" data-placement="top" title="Click to Change Status">
                                       ...
                                       <td>
                                          <a href="<?php bs() ?>content_manager/edit/<?php echo $post->id ?>">
                                          ...
                                          <a onclick="deleteFunction('<?php bs() ?>content_manager/delete_content/<?php echo $post->id ?>')" href="javascript:void(0)">
